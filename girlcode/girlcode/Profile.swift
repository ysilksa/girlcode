...
// TO DO
// center the username and looking to fields and if the user types too much, how to stop
// when you type in the username and looking to fields, make the text pink
// add fonts 
