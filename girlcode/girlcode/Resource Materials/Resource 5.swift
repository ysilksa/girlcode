...
struct Resource_5: View {
    var body: some View {
        ZStack {
            ...
            Text("The Women's Law Initiative provides free legal information and support for women facing domestic violence, sexual assault, and other forms of gender-based violence. Through their website, women can access resources on legal rights, protective orders, and custody issues. They also offer guidance on navigating the legal system to ensure safety and justice.")
